<div class="glass-dark rounded-2xl p-8 shadow-2xl">
    ...
    <div class="space-y-4">
        <div class="glass rounded-xl p-4 hover:scale-105 transition-transform duration-300 cursor-pointer">
            <h3 class="text-white font-semibold mb-2">Wszystkie</h3>
        </div>
        <div class="glass rounded-xl p-4 hover:scale-105 transition-transform duration-300 cursor-pointer">
            <h3 class="text-white font-semibold mb-2">Ulubione</h3>
        </div>
        <div class="glass rounded-xl p-4 hover:scale-105 transition-transform duration-300 cursor-pointer">
            <h3 class="text-white font-semibold mb-2">Domyślna</h3>
        </div>
        <div class="glass rounded-xl p-4 hover:scale-105 transition-transform duration-300 cursor-pointer">
            <h3 class="text-white font-semibold mb-2">Lista notatek</h3>
        </div>
    </div>
</div>